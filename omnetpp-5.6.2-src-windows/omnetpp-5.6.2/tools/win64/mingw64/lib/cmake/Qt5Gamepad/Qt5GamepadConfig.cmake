...
macro(_populate_Gamepad_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (_Qt5Gamepad_LIB_DEPENDENCIES)
        set(_list_sep ";")
    endif()
    set_target_properties(Qt5::Gamepad PROPERTIES
        "INTERFACE_LINK_LIBRARIES_${Configuration}" "${_Qt5Gamepad_LIB_DEPENDENCIES}${_list_sep}${_Qt5Gamepad_STATIC_${Configuration}_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5Gamepad_LIB_DEPENDENCIES}${_list_sep}${_Qt5Gamepad_STATIC_${Configuration}_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::Gamepad)
    ...
    set(Qt5Gamepad_PRIVATE_INCLUDE_DIRS
        "${_qt5Gamepad_install_prefix}/include/QtGamepad/5.9.1"
        "${_qt5Gamepad_install_prefix}/include/QtGamepad/5.9.1/QtGamepad"
    )
    ...
    file(GLOB pluginTargetsMaybe "${CMAKE_CURRENT_LIST_DIR}/Qt5Gamepad_*.cmake")
    unset(pluginTargets)
    if (pluginTargetsMaybe)
        foreach(pluginTarget ${pluginTargetsMaybe})
            ...
            file(STRINGS ${pluginTarget} matched REGEX Qt5Gamepad_PLUGINS)
            if (matched)
    ...
    macro(_populate_Gamepad_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        string(REGEX REPLACE "^lib(.*)\\.a" "${_qt5Gamepad_install_prefix}/share/qt5/plugins/${_plugindirname}/\\1.prl" plugin_prl_file_location ${_pluginname})
    ...
    _populate_Gamepad_target_properties(RELEASE "Qt5Gamepad.dll" "libQt5Gamepad.dll.a" )



    _populate_Gamepad_target_properties(DEBUG "Qt5Gamepadd.dll" "libQt5Gamepadd.dll.a" )
