...
macro(_populate_3DAnimation_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (_Qt53DAnimation_LIB_DEPENDENCIES)
        set(_list_sep ";")
    endif()
    set_target_properties(Qt5::3DAnimation PROPERTIES
        "INTERFACE_LINK_LIBRARIES_${Configuration}" "${_Qt53DAnimation_LIB_DEPENDENCIES}${_list_sep}${_Qt53DAnimation_STATIC_${Configuration}_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt53DAnimation_LIB_DEPENDENCIES}${_list_sep}${_Qt53DAnimation_STATIC_${Configuration}_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::3DAnimation)
    ...
    set(Qt53DAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DAnimation_install_prefix}/include/Qt3DAnimation/5.9.1"
        "${_qt53DAnimation_install_prefix}/include/Qt3DAnimation/5.9.1/Qt3DAnimation"
    )
    ...
    macro(_populate_3DAnimation_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        string(REGEX REPLACE "^lib(.*)\\.a" "${_qt53DAnimation_install_prefix}/share/qt5/plugins/${_plugindirname}/\\1.prl" plugin_prl_file_location ${_pluginname})
    ...
    _populate_3DAnimation_target_properties(RELEASE "Qt53DAnimation.dll" "libQt53DAnimation.dll.a" )



    _populate_3DAnimation_target_properties(DEBUG "Qt53DAnimationd.dll" "libQt53DAnimationd.dll.a" )
