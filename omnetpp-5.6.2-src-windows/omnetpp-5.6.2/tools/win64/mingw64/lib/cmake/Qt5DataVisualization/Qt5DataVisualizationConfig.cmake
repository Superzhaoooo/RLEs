...
macro(_populate_DataVisualization_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (_Qt5DataVisualization_LIB_DEPENDENCIES)
        set(_list_sep ";")
    endif()
    set_target_properties(Qt5::DataVisualization PROPERTIES
        "INTERFACE_LINK_LIBRARIES_${Configuration}" "${_Qt5DataVisualization_LIB_DEPENDENCIES}${_list_sep}${_Qt5DataVisualization_STATIC_${Configuration}_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt5DataVisualization_LIB_DEPENDENCIES}${_list_sep}${_Qt5DataVisualization_STATIC_${Configuration}_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::DataVisualization)
    ...
    set(Qt5DataVisualization_PRIVATE_INCLUDE_DIRS
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.9.1"
        "${_qt5DataVisualization_install_prefix}/include/QtDataVisualization/5.9.1/QtDataVisualization"
    )
    ...
    file(GLOB pluginTargetsMaybe "${CMAKE_CURRENT_LIST_DIR}/Qt5DataVisualization_*.cmake")
    unset(pluginTargets)
    if (pluginTargetsMaybe)
        foreach(pluginTarget ${pluginTargetsMaybe})
            ...
            file(STRINGS ${pluginTarget} matched REGEX Qt5DataVisualization_PLUGINS)
            if (matched)
    ...
    macro(_populate_DataVisualization_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        string(REGEX REPLACE "^lib(.*)\\.a" "${_qt5DataVisualization_install_prefix}/share/qt5/plugins/${_plugindirname}/\\1.prl" plugin_prl_file_location ${_pluginname})
    ...
    _populate_DataVisualization_target_properties(RELEASE "Qt5DataVisualization.dll" "libQt5DataVisualization.dll.a" )



    _populate_DataVisualization_target_properties(DEBUG "Qt5DataVisualizationd.dll" "libQt5DataVisualizationd.dll.a" )
