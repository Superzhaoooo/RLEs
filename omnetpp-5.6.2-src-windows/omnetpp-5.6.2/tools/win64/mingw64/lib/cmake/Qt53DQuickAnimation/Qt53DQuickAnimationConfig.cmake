...
macro(_populate_3DQuickAnimation_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    if (_Qt53DQuickAnimation_LIB_DEPENDENCIES)
        set(_list_sep ";")
    endif()
    set_target_properties(Qt5::3DQuickAnimation PROPERTIES
        "INTERFACE_LINK_LIBRARIES_${Configuration}" "${_Qt53DQuickAnimation_LIB_DEPENDENCIES}${_list_sep}${_Qt53DQuickAnimation_STATIC_${Configuration}_LIB_DEPENDENCIES}"
        "IMPORTED_LOCATION_${Configuration}" ${imported_location}
        # For backward compatibility with CMake < 2.8.12
        "IMPORTED_LINK_INTERFACE_LIBRARIES_${Configuration}" "${_Qt53DQuickAnimation_LIB_DEPENDENCIES}${_list_sep}${_Qt53DQuickAnimation_STATIC_${Configuration}_LIB_DEPENDENCIES}"
    )
...
if (NOT TARGET Qt5::3DQuickAnimation)
    ...
    set(Qt53DQuickAnimation_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickAnimation_install_prefix}/include/Qt3DQuickAnimation/5.9.1"
        "${_qt53DQuickAnimation_install_prefix}/include/Qt3DQuickAnimation/5.9.1/Qt3DQuickAnimation"
    )
    ...
    file(GLOB pluginTargetsMaybe "${CMAKE_CURRENT_LIST_DIR}/Qt53DQuickAnimation_*.cmake")
    unset(pluginTargets)
    if (pluginTargetsMaybe)
        foreach(pluginTarget ${pluginTargetsMaybe})
            ...
            file(STRINGS ${pluginTarget} matched REGEX Qt53DQuickAnimation_PLUGINS)
            if (matched)
    ...
    macro(_populate_3DQuickAnimation_plugin_properties Plugin Configuration PLUGIN_LOCATION)
        ...
        string(REGEX REPLACE "^lib(.*)\\.a" "${_qt53DQuickAnimation_install_prefix}/share/qt5/plugins/${_plugindirname}/\\1.prl" plugin_prl_file_location ${_pluginname})
    ...
    _populate_3DQuickAnimation_target_properties(RELEASE "Qt53DQuickAnimation.dll" "libQt53DQuickAnimation.dll.a" )



    _populate_3DQuickAnimation_target_properties(DEBUG "Qt53DQuickAnimationd.dll" "libQt53DQuickAnimationd.dll.a" )
